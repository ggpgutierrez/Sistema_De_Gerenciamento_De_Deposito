    ...
    public partial class formventa : MaterialForm
    {
        ...
        private void btnIncluir_Click(object sender, EventArgs e)
        {
            ...
            if (controlador.chamarItem(produto).idProduto == null)
            {
                ...
                else
                {
                    ...
                    {
                    if (Convert.ToInt32(controlador.chamarItem(produto).Qtd) < Convert.ToInt32(txtQtd.Text))
                    {
        ...
        private void Print_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            using (Font font = new Font("Arial", 16))
            {
                ...
                {
                    double total = Convert.ToDouble(prod.Qtd) * Convert.ToDouble(prod.ValorUnit);
                    totalFinal += Convert.ToDouble(prod.Qtd) * Convert.ToDouble(prod.ValorUnit);
                    linha += 20;
                    g.DrawString(prod.nomeProduto, font, Brushes.Black, 105, linha);
                    g.DrawString(prod.Qtd, font, Brushes.Black, 310, linha);
                    g.DrawString(prod.UnidadeMedida, font, Brushes.Black, 450, linha);
